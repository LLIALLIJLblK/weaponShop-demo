...
public class Rifle extends AbstractWeapon {
    ...
    public Rifle(String weaponName, String weaponBuildersCountry, boolean automatic, String caliber, double weaponMass, int maxBulletSpeed, ClipType clipType, int bulletCount, String serialCode, double price) {
    ...
    public int reload(ClipType clipType) {
        System.out.println(ClipType.CAROB_CLIP_RIFLE.getClip() + " has been reloaded: " + bulletCount);
        return bulletCount;
    }
